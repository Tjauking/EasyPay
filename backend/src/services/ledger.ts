...
export async function getOrCreateWallet(userId: string, currency: string): Promise<{ id: string; balance: string }> {
...
export async function creditWallet(userId: string, currency: string, amount: number): Promise<void> {
...
export async function debitWallet(userId: string, currency: string, amount: number): Promise<void> {
  await pool.query('BEGIN');
  try {
    await getOrCreateWallet(userId, currency);
