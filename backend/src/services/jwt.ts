import { SignJWT, jwtVerify, importSPKI, importPKCS8, JWTPayload } from 'jose';
import { getSigningKeys } from '../config.js';

const ALG = 'ES256';

export async function generateAccessToken(subject: string, claims: Record<string, unknown> = {}): Promise<string> {
