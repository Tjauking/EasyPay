...
router.post('/initiate', requireAuth, async (req, res, next) => {
  try {
    ...
    const txn = await pool.query(
      'INSERT INTO transactions (id, type, status, from_user, to_user, amount, currency) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING id',
      [txnId, 'remit', 'funded', userId, null, amountUsdT, 'USDt']
    );
